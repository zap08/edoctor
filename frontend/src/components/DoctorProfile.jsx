    ...
    <div className="doctorProfile">
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ width: "90%" }}>
            ...
            {formErrors.doctorName && (
              <p className="error">{formErrors.doctorName}</p>
            )}
          </div>
          <div style={{ width: "90%" }}>
            <input
            ...
            />
            {formErrors.doctorId && (
              <p className="error">{formErrors.doctorId}</p>
            )}
          </div>
          <div style={{ width: "90%" }}>
            <input
            ...
            {formErrors.speciality && (
              <p className="error">{formErrors.speciality}</p>
            )}
          </div>
          <div style={{ width: "90%" }}>
            <input
      ...
      {profileData && (
        <div className="profile">
          ...
          <p>
            <strong>Specialization:</strong> {profileData.speciality}
          </p>
          <p>
